...
export function NominasSelectionBanner({
  ...
  return createPortal(
    <div
      className="pointer-events-none fixed inset-x-0 bottom-4 z-[9999] flex justify-center px-4 sm:px-6"
      role="status"
      aria-live="polite"
    >
      <div
        className={cn(
          'pointer-events-auto w-full max-w-5xl transition-all duration-300 ease-out',
