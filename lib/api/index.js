 ...
 */
export function createVaclyClient(config) {
 ...
 */
export async function processNominaFile(file, config) {
    try {
 ...
 */
export async function extractNominaInfo(content, config) {
    try {
 ...
 */
export async function getNominas(config, options) {
    try {
 ...
 */
export async function searchNominas(config, filters) {
    try {
        const client = createVaclyClient(config);
        let query = client.supabase
            .from('nominas')
 ...
 */
export async function deleteNomina(config, nominaId) {
    try {
        const client = createVaclyClient(config);
