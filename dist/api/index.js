...
function createVaclyClient(config) {
    const supabase = supabaseJs.createClient(config.supabaseUrl, config.supabaseServiceKey);
...
exports.createVaclyClient = createVaclyClient;
exports.deleteNomina = deleteNomina;
exports.extractNominaInfo = extractNominaInfo;
exports.getNominas = getNominas;
exports.processNominaFile = processNominaFile;
exports.searchNominas = searchNominas;
